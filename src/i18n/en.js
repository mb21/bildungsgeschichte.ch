export default {
  Global: {
    appTitle: 'History of Education Switzerland'
  , loading: 'Loading…'
  , open: 'Open'
  , more: 'show more'
  , from: 'From'
...
<h2>The Project</h2>
<h3>Project Goals</h3>
<p>The <em>History of Education</em> knowledge portal enables researchers,</p>
<p>students, teachers and interested members of the public to carry out discipline-specific and multilingual research on sources and data relating to the history of education research in Switzerland.</p>
<p>The information potential of various digital sources on the history of education is accessible through a search mask</p>
...
<h4 id="project-lead-technical-development-phase">Project lead (technical development phase)</h4>
<p>Prof. Dr. Lucien Criblez; Dr. Christina Rothen; Dr. Thomas Ruoss (University of Zurich)</p>
...
<p>Project team Bildung in Zahlen (Education by Numbers)</p>
<p>Many thanks to Andrea Malits, Florian Steurer, Cyrus Beck, Simon Allemann, Alexandre Fontaine, Giorgia Masoni, Anja Giudici, Lars Müller and Wolfgang Saalfeld.</p>
      `
  }
, Projects: {
    text: `
<h2 id="collections">Collections</h2>
<p>(Status 23.05.2018)</p>
